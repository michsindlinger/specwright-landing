---
description: Transfer Brainstorming to Spec Rules for Specwright
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<command_execution>
  EXECUTE: @specwright/workflows/core/create-spec.md
...
<session_update>
  ...
  **Spec Location:** @specwright/specs/[SPEC_ID]/spec.md
...
<transfer_summary>
  ...
  **New Spec:** [SPEC_ID] - [FEATURE_NAME]
  ...
  ### Created Files
  - Specification: @specwright/specs/[SPEC_ID]/spec.md
  - Quick Reference: @specwright/specs/[SPEC_ID]/spec-lite.md
  - Implementation Tasks: @specwright/specs/[SPEC_ID]/tasks.md
