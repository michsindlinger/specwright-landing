---
description: Transfer Brainstorming to Bug Report Rules for Specwright
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<command_execution>
  EXECUTE: @specwright/workflows/core/create-bug.md
...
<session_update>
  ...
  **Bug ID:** [BUG_ID]
  **Bug Report:** @specwright/bugs/[BUG_FOLDER]/bug-report.md
...
<transfer_summary>
  ...
  **Severity:** [SEVERITY_LEVEL]
  ...
  ### Created Structure
  - Bug Report: @specwright/bugs/[BUG_FOLDER]/bug-report.md
  - Investigation: @specwright/bugs/[BUG_FOLDER]/investigation/
  - Resolution: @specwright/bugs/[BUG_FOLDER]/resolution/
