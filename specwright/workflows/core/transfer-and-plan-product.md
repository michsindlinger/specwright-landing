---
description: Transfer Brainstorming to Product Planning Rules for Specwright
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<session_discovery>
  SCAN specwright/brainstorming/ for sessions
...
<information_preparation>
  ...
  <add_transfer_metadata>
    ...
    - session_path: "specwright/brainstorming/[SESSION_ID]/session.md"
...
<command_execution>
  EXECUTE: @specwright/workflows/core/plan-product.md
...
<session_update>
  ...
  **Product Docs Location:** @specwright/product/
  ...
  **Status:** Transferred
  ...
  ### Created Files
  - Mission: @specwright/product/mission.md
  - Tech Stack: @specwright/product/tech-stack.md
  - Roadmap: @specwright/product/roadmap.md
  - Decisions: @specwright/product/decisions.md
  - Mission Lite: @specwright/product/mission-lite.md
...
<transfer_summary>
  ...
  **Product Documentation Created:** Complete product planning suite
  ...
  ### Created Files
  - Product Mission: @specwright/product/mission.md
  - Mission Summary: @specwright/product/mission-lite.md
  - Technical Stack: @specwright/product/tech-stack.md
  - Development Roadmap: @specwright/product/roadmap.md
  - Decision Log: @specwright/product/decisions.md
