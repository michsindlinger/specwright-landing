---
description: Retroactive Feature Documentation Rules for Specwright
globs:
alwaysApply: false
version: 2.0
encoding: UTF-8
...
Analyze the existing codebase using Glob, Grep, and Read tools to identify implemented features that lack documentation.
...
<step number="2" name="feature_discovery">

### Step 2: Feature Discovery & Categorization

Group discovered code elements into logical features and present them to the user.
...
<step number="3" name="feature_analysis">

### Step 3: Deep Feature Analysis

Thoroughly analyze the selected feature's implementation using Read tool on all relevant files.
...
<folder_structure>
  <main_folder>specwright/specs/YYYY-MM-DD-retro-feature-name/</main_folder>
  <required_files>
...
Use the file-creator subagent to create comprehensive user-facing documentation in the specwright/docs/ structure.

<docs_structure_creation>
  <directory_setup>
    CREATE: specwright/docs/[FEATURE_NAME]/
    CREATE: specwright/docs/[FEATURE_NAME]/sub-features/ (if hierarchical)
  </directory_setup>
</docs_structure_creation>
...
<cross_reference_strategy>
  <spec_to_docs>
    ...
    FORMAT: "## User Documentation\n\nSee: @specwright/docs/[FEATURE_NAME]/feature.md"
  </spec_to_docs>
  <docs_to_spec>
    ADD: Reference in user docs pointing to technical spec
    FORMAT: "## Technical Details\n\nFor implementation details: @specwright/specs/[RETRO_SPEC]/spec.md"
  </docs_to_spec>
  <retro_notation>
...
<documentation_index_update>
  <index_management>
    IF specwright/docs/README.md exists:
...
<user_review_presentation>
  <review_request>
    ...
    **Retroactive Specification:**
    - Main Spec: @specwright/specs/[RETRO_SPEC]/spec.md
    - Technical Details: @specwright/specs/[RETRO_SPEC]/technical-spec.md
    - Process Notes: @specwright/specs/[RETRO_SPEC]/retro-notes.md
    
    **User Documentation:**
    - Main Guide: @specwright/docs/[FEATURE_NAME]/feature.md
