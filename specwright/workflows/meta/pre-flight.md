---
description: Common Pre-Flight Steps for Specwright Instructions
globs:
alwaysApply: false
version: 2.0
encoding: UTF-8
...
```
1. TRY: specwright/templates/[category]/[template].md (project)
2. IF "Error reading file" OR "File does not exist":
   READ: ~/.specwright/templates/[category]/[template].md (global fallback)
...
⚠️ **WICHTIG:** Bei "Error reading file" NIEMALS abbrechen - IMMER den ~/.specwright/ Fallback-Pfad versuchen!
